...
def main():
    ...
    with open('Fuzzy9993.csv', 'w', newline='') as csvfile:
        ...
        try:
            ...
            while True:
                ...
                left, right = boat_controller.fuzzy_controller(1, 0, angle_diff/180.0, norm_left_motor_speed, norm_right_motor_speed)
      
                left *= 50  # Maximum speed for left motor.
                right *= 50  # Maximum speed for right motor.
