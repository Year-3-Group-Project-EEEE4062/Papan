...
class MechaQMC5883:
    """
    Class for interfacing with the QMC5883 magnetometer sensor. offset_x=230.143, offset_y=19.02,
    """
    def __init__(self, offset_x=292.49, offset_y=19.02):
        """
...
if __name__ == "__main__":
    ...
    while True:
        ...
        [x, y, z, x_ori, y_ori, z_ori] = qmc5883.read()
        
        # Calculate the azimuth angle based on the sensor data.
        a = qmc5883.azimuth(y_ori, x_ori)
        b = qmc5883.azimuth(y, x)
        
        # Print sensor data and azimuth angle.
        print(f"Without Offset: {a}, With Offset: {b}")
