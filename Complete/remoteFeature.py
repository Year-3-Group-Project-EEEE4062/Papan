...
class remoteClass:
    ...
    def processRemoteMssg(self, remoteMssg, boatBusy, temperatureOperation):
        ...
        Returns:
            Boolean: Boat busy state, start or stop temperature measurement, array of [movement, speed].
        """
        process = [100, 0]
        ...
        elif(len(remoteMssg) == 2 and not(boatBusy == True)):
        ...
        return boatBusy, temperatureOperation, process
