...
class autoClass:
    def __init__(self, l_motor, r_motor, send_cb, init_time):
        ...
        # Staight line path
        #self.waypoints = [[2.944606, 101.874412], [2.944519, 101.874483], [2.944435, 101.874569], [2.944363, 101.874662], [2.944292, 101.874764]]
        
        # Walk S shape path.
        #self.waypoints = [[2.944693, 101.874419], [2.944636, 101.874382], [2.944653, 101.874463], [2.944602, 101.874461]]
        
        # Testing.
        #self.waypoints = [[2.943588, 101.877838]]
        self.waypoints = []
    ...
    def runAutonomous(self, boatBusy):
        ...
        with open('autoMode.csv', 'a', newline='') as csvfile:
            ...
            if self.waypointIndex < self.obtainedWaypoints:
                ########################################################################
                ...
                left *= 50
                right *= (50*0.5)       # Change scaling factor to 0.5 cuz right motor is too powerful.
