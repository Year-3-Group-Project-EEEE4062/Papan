...
x = np.linspace(-1, 1, 101)   # Generate 51 evenly spaced values from -1 to 1 for x-axis.
y = np.linspace(0, 1, 101)    # Generate 51 evenly spaced values from 0 to 1 for y-axis.
[x, y] = np.meshgrid(x, y)
